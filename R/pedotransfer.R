...
#' @export
#' # https://github.com/mrke/NicheMapR/blob/master/R/pedotransfer.R
#' 
load("/Users/raghav/Library/CloudStorage/Box-Box/FVS_NEON/Scripts/R/funs_to_estimate_soil_properties/data/Cosby1984Tbl5.RData")
load("/Users/raghav/Library/CloudStorage/Box-Box/FVS_NEON/Scripts/R/funs_to_estimate_soil_properties/data/Cosby1984Tbl4.RData")
